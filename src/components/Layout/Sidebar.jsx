        ...
        <aside className="app-sidebar">
            <div style={{ paddingBottom: '2rem', borderBottom: '1px solid rgba(255,255,255,0.1)', marginBottom: '2rem' }}>
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <h2 style={{ margin: 0, fontSize: '1.25rem' }}>Primaria N°6 <br /><span style={{ color: 'var(--color-accent)', fontSize: '1rem' }}>Calificador Digital</span></h2>
                </div>
                <p style={{ margin: 0, fontSize: '0.875rem', opacity: 0.8, color: '#e2e8f0' }}>Provincia de Buenos Aires</p>
            </div>
